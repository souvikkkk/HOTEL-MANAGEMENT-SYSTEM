...
class CheckIN:
    ...
    def __init__(self, root):
        ...
        # display message
        self.label = Label(self.top, font=('Times New Roman', 50, 'bold'), text="CHECK IN", fg="#15d3ba", anchor="center")
        self.label.grid(row=0, column=3, padx=10, pady=10)

        # name label
        self.name_label = Label(self.bottom, font=('Times New Roman', 20, 'bold'), text="ENTER YOUR NAME :", fg="#15d3ba",
                                anchor="w")
        ...
        # address label
        self.address_label = Label(self.bottom, font=('Times New Roman', 20, 'bold'), text="ENTER YOUR ADDRESS :", fg="#15d3ba",
                                   anchor="w")
        ...
        self.mobile_label = Label(self.bottom, font=('Times New Roman', 20, 'bold'), text="ENTER YOUR MOBILE NUMBER :",
                                  fg="#15d3ba",
                                  anchor="w")
        ...
        self.days_label = Label(self.bottom, font=('Times New Roman', 20, 'bold'), text="ENTER NUMBER OF DAYS TO STAY :",
                                fg="#15d3ba",
                                anchor="w")
        ...
        # room number label
        self.room_number_label = Label(self.bottom, font=('Times New Roman', 20, 'bold'), text="ROOM NUMBER: ",
                                       fg="#15d3ba",
                                       anchor="w")
